...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/sidebar_combined.png}{
    \includegraphics[width=0.82\textwidth]{images/web_crops/sidebar_combined.png}
  }{
...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/web_step_view.png}{
    \includegraphics[width=0.86\textwidth]{images/web_crops/web_step_view.png}
  }{
...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/web_target_curve.png}{
    \includegraphics[width=0.78\textwidth]{images/web_crops/web_target_curve.png}
  }{
...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/web_circuit_view.png}{
    \includegraphics[width=0.86\textwidth]{images/web_crops/web_circuit_view.png}
  }{
...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/web_noise_view.png}{
    \includegraphics[width=0.86\textwidth]{images/web_crops/web_noise_view.png}
  }{
...
\begin{figure}[!htbp]
  ...
  \IfFileExists{images/web_crops/web_theory_view.png}{
    \includegraphics[width=0.86\textwidth]{images/web_crops/web_theory_view.png}
  }{
